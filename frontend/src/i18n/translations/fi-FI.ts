export default {
  ...
  "home.bullet.a.description": "Isännöi \"Rxtx Share\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Rxtx Share on saatavilla",
