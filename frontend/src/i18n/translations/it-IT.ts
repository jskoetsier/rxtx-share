export default {
  ...
  "home.bullet.a.description": "Configura Rxtx Share sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato Rxtx Share tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL Rxtx Share è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente Rxtx Share mantiene la cache in memoria. Se si eseguono più istanze di Rxtx Share, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
