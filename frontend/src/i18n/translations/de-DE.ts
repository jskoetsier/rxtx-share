export default {
  ...
  "home.bullet.a.description": "Betreibe Rxtx Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Rxtx Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Rxtx Share verfügbar ist",
  ...
  "admin.config.cache.redis-enabled.description": "Normally Rxtx Share caches information in memory. If you run multiple instances of Rxtx Share, you need to enable Redis caching to share the cache between the instances.",
