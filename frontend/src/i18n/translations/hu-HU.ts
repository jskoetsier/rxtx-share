export default {
  ...
  "home.bullet.a.description": "A Rxtx Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Rxtx Share megosztáskezelőre mutató hivatkozás",
