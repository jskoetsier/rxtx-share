export default {
  ...
  "home.bullet.a.description": "Utrzymuj Rxtx Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Rxtx Share jest dostępny",
