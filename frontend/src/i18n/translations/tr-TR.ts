export default {
  ...
  "home.bullet.a.description": "Rxtx Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Rxtx Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Rxtx Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Rxtx Share bilgileri bellekte önbellekler. Birden fazla Rxtx Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
