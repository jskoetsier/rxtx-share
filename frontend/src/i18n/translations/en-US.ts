export default {
  ...
  "home.bullet.a.description": "Host Rxtx Share on your own machine.",
  ...
  "admin.config.config-file-warning.description":
    "As you have a configured Rxtx Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description":
    "On which URL Rxtx Share is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally Rxtx Share caches information in memory. If you run multiple instances of Rxtx Share, you need to enable Redis caching to share the cache between the instances.",
