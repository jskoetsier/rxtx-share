/**
 * Single source of truth for config variable definitions (no DB side effects).
 * Imported by the Prisma seed and by compile-time config typing.
 */
...
export const configVariables = {
  ...
  cache: {
    ...
    "redis-url": {
      type: "string",
      defaultValue: "redis://rxtx-redis:6379",
      secret: true,
    },
    ttl: {
      type: "number",
  ...
  email: {
    ...
    resetPasswordSubject: {
      type: "string",
      defaultValue: "Rxtx Share password reset",
    },
    ...
    inviteSubject: {
      type: "string",
      defaultValue: "Rxtx Share invite",
    },
    inviteMessage: {
      type: "text",
      defaultValue:
        'Hey!\n\nYou were invited to Rxtx Share. Click this link to accept the invite: {url}\n\nYou can use the email "{email}" and the password "{password}" to sign in.\n\nRxtx Share 🐧',
    },
  },
  smtp: {
    enabled: {
